    ...
    <div className="relative -bottom-15 -mt-15 z-10 px-2">
      ...
      >
        <div className="flex flex-col-reverse lg:gap-5 xl:gap-25.75 lg:flex-row justify-between">
          <div>
            <div>
              <p className="text-[35px] max-lg:hidden font-semibold text-nowrap" style={{ color: 'var(--color-on-surface)' }}>
          ...
          <div className="w-full overflow-y-scroll py-6.5">
            <p className="text-xl mb-2 xs:text-2xl sm:text-2xl md:text-[38px] font-semibold lg:hidden text-center" style={{ color: 'var(--color-on-surface)' }}>
              Let’s discuss your Project
            </p>
            <Form />
          </div>
